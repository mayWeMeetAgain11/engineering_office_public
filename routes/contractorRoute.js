...
router.post('/contractor/store', validation.storeContractor, contractorController.contractorLogin);

router.post('/category/store', validation.storeCategory, contractorUpload.single('image'), contractorController.storeCategory);

router.post('/contractor-main-document/store', validation.storeMainDocument, upload.single('pdf'), contractorController.contractorMainDocumentStore);
...
router.get('/contractor/stage-materials/:id', contractorController.getAllProjectInOneOffice);
